...
[![Build Status](https://travis-ci.org/sfwtoms2030/go-binance.svg?branch=master)](https://travis-ci.org/sfwtoms2030/go-binance)
[![GoDoc](https://godoc.org/github.com/sfwtoms2030/go-binance?status.svg)](https://godoc.org/github.com/sfwtoms2030/go-binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/sfwtoms2030/go-binance)](https://goreportcard.com/report/github.com/sfwtoms2030/go-binance)
[![codecov](https://codecov.io/gh/sfwtoms2030/go-binance/branch/master/graph/badge.svg)](https://codecov.io/gh/sfwtoms2030/go-binance)
...
```shell
go get github.com/sfwtoms2030/go-binance/v2
```

For v1 API, it has been moved to `v1` branch, please use:

```shell
go get github.com/sfwtoms2030/go-binance/v1
```
...
```golang
import (
    "github.com/sfwtoms2030/go-binance/v2"
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/sfwtoms2030/go-binance) for full references.
...
```go
import (
    "github.com/sfwtoms2030/go-binance/v2/futures"
)
